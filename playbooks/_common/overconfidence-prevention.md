...
- [`docs/internals/issue-analysis-process.md`](../../docs/internals/issue-analysis-process.md) — the **plugin-internal** counterpart for working on this repo's own backlog issues. Different audience (plugin maintainers, not consumers), different failure mode (first-pass satisficing on issue analysis vs. consumer-runtime overconfidence skipping clarifying questions). Read together: this file covers consumer-AI-DLC-stage runtime; that file covers plugin-issue analysis.